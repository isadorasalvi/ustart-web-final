...
export class PedidoComponent implements OnInit {
  ...
  public novo(): void {
    const url = `${AppRoutes.Pedidos.Cadastro()}/novo`;
  ...
  private pesquisar(pesquisa: string): void {
    this.loading = true;
    this.pedidoService.get(pesquisa).subscribe(
      (result) => {
        this.pedidos = result;
  ...
  public editar(pedido: Pedido): void {
    var url = `${AppRoutes.Pedidos.Cadastro()}/${pedido.id}`;
    this.router.navigateByUrl(url);
  }

  public excluir(pedido: Pedido): void {
    if (confirm(`Deseja excluir o registro ${pedido.id}?`)) {
